const DescriptionTab = () => {
  return (
    <div className="firstTab">
        Lorem, ipsum dolor sit amet consectetur adipisicing elit. Excepturi quo sequi est, 
        reiciendis nihil vitae dolore aliquam totam aspernatur doloremque eius,
         vero minima praesentium expedita commodi amet, nemo culpa architecto?
         <ul>
